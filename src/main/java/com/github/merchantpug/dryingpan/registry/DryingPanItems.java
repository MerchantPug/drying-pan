...
public class DryingPanItems {
    ...
    public static final RegistryObject<FryingPanItem> FRYING_PAN = ITEMS.register("frying_pan", () -> new FryingPanItem(new Item.Properties().defaultDurability(250).tab(ItemGroup.TAB_TOOLS)));
